...
document.addEventListener("DOMContentLoaded", function() {
    ...
    ComF_Número=document.getElementById("txtnumcf");
    ...
    ComC_Número=document.getElementById("txtnumcc");
...
async function renderCrearCompromisosF() {
   const obj = {
    ComF_Número: parseInt(ComF_Número.value),
...
async function renderCrearCompromisosC() {
   const obj = {
    ComC_Número: parseInt(ComC_Número.value),
...
ipcRenderer.on('Cfuncional', (event, result) => {
   ...
   ComF_Número.value = result.ComF_Número
...
ipcRenderer.on('CComportamental', (event, result) => {
   ...
   ComC_Número.value = result.ComC_Número
