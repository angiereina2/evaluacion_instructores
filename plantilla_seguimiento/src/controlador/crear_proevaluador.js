...
document.addEventListener("DOMContentLoaded", function() {
    ...
    ProE_NombreApellido	= document.getElementById("txtnombreproe")
...
async function renderCrearevaluador() {
   const obj = {
    ...
    ProE_NombreApellido:ProE_Nombre.value,
   ...
   new Notification('Evaluador', {
      body: 'Evaluador Registrado Exitosamente'
    })
}
