...
Pro_Código = document.getElementById("txtcodev");
...
ProE_Código = document.getElementById("txtcodevr");
...
C_Código= document.getElementById("txtcodevc");
...
ipcRenderer.on('proEvaluados', (event, result) => {
      ...
      Pro_Código.value = result.Pro_Código
      ...
      ProE_Código.value = result.ProE_Código
      ...
      C_Código.value = result.C_Código
